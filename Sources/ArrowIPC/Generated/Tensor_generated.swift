...
public struct org_apache_arrow_flatbuf_TensorDim: FlatBufferTable,
  FlatbuffersVectorInitializable, Verifiable
{
  ...
  public var nameSegmentArray: [UInt8]? {
    _accessor.getVector(at: VTOFFSET.name.v)
  }
  ...
  public static func endTensorDim(
  ...
  public static func verify<T>(
    ...
    try _v.visit(
      field: VTOFFSET.size.p, fieldName: "size", required: false,
      type: Int64.self)
    try _v.visit(
      field: VTOFFSET.name.p, fieldName: "name", required: false,
      type: ForwardOffset<String>.self)
    _v.finish()
  }
}

public struct org_apache_arrow_flatbuf_Tensor: FlatBufferTable,
  FlatbuffersVectorInitializable, Verifiable
{
  ...
  public var typeType: org_apache_arrow_flatbuf_Type_ {
    ...
    return o == 0
      ? .none_
      : org_apache_arrow_flatbuf_Type_(
  ...
  public var shape: FlatbufferVector<org_apache_arrow_flatbuf_TensorDim> {
    _accessor.vector(at: VTOFFSET.shape.v, byteSize: 4)
  }
  ///  Non-negative byte offsets to advance one value cell along each dimension
  ///  If omitted, default to row-major order (C-like).
  public var strides: FlatbufferVector<Int64> {
    _accessor.vector(at: VTOFFSET.strides.v, byteSize: 8)
  }
  public func withUnsafePointerToStrides<T>(
    _ body: (UnsafeRawBufferPointer, Int) throws -> T
  ) rethrows -> T? {
    try _accessor.withUnsafePointerToSlice(at: VTOFFSET.strides.v, body: body)
  }
  ...
  public var mutableData: org_apache_arrow_flatbuf_Buffer_Mutable! {
    let o = _accessor.offset(VTOFFSET.data.v)
    return org_apache_arrow_flatbuf_Buffer_Mutable(
  ...
  public static func add(
    typeType: org_apache_arrow_flatbuf_Type_, _ fbb: inout FlatBufferBuilder
  ...
  public static func addVectorOf(
    strides: Offset, _ fbb: inout FlatBufferBuilder
  ) { fbb.add(offset: strides, at: VTOFFSET.strides.p) }
  public static func add(
    data: org_apache_arrow_flatbuf_Buffer?, _ fbb: inout FlatBufferBuilder
  ) {
    guard let data = data else { return }
    fbb.create(struct: data, position: VTOFFSET.data.p)
  }
  public static func endTensor(_ fbb: inout FlatBufferBuilder, start: UOffset)
    -> Offset
  {
    let end = Offset(offset: fbb.endTable(at: start))
  ...
  public static func verify<T>(
    ...
    var _v = try verifier.visitTable(at: position)
    try _v.visit(
      unionKey: VTOFFSET.typeType.p, unionField: VTOFFSET.type.p,
      unionKeyName: "typeType", fieldName: "type", required: true,
      completion: { (verifier, key: org_apache_arrow_flatbuf_Type_, pos) in
        ...
        case .fixedsizebinary:
          try ForwardOffset<org_apache_arrow_flatbuf_FixedSizeBinary>.verify(
            &verifier, at: pos,
            of: org_apache_arrow_flatbuf_FixedSizeBinary.self)
        case .fixedsizelist:
        ...
        case .binaryview:
          try ForwardOffset<org_apache_arrow_flatbuf_BinaryView>.verify(
            &verifier, at: pos, of: org_apache_arrow_flatbuf_BinaryView.self)
        case .utf8view:
          try ForwardOffset<org_apache_arrow_flatbuf_Utf8View>.verify(
            &verifier, at: pos, of: org_apache_arrow_flatbuf_Utf8View.self)
        case .listview:
          try ForwardOffset<org_apache_arrow_flatbuf_ListView>.verify(
            &verifier, at: pos, of: org_apache_arrow_flatbuf_ListView.self)
        case .largelistview:
          try ForwardOffset<org_apache_arrow_flatbuf_LargeListView>.verify(
            &verifier, at: pos, of: org_apache_arrow_flatbuf_LargeListView.self)
        }
      })
    try _v.visit(
